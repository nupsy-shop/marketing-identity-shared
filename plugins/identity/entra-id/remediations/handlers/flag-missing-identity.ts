/**
 * entra-id:flag_missing_identity
 *
 * Drift remediation for HUMAN_INTERACTIVE identities whose email is absent
 * from the Entra ID directory cache. Marks the identity as `not_found`,
...
export const flagMissingIdentityHandler: RemediationActionHandler = async (
  ...
  return flagMissingIdentity('entra-id', params, context, instance);
};
